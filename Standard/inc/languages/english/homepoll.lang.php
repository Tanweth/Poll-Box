...
$l['homepoll_description_asb'] = "Displays a fully-functional MyBB poll in a sidebox, specified by forum or poll ID.";
...
// Title and description for settings (non-ASB only).
...
$l['homepoll_compact_title'] = "Use Compact Version?";
